...
const frames = ['/assets/SuperPellet.png', '/assets/SuperPellet2.png'];
...
export function getSuperPelletSprite(row: number, col: number) {
  return document.querySelector<HTMLDivElement>(
    `[data-r="${row}"][data-c="${col}"][data-type='SuperPellet']`
  );
}

export default function SuperPelletSprite({
  row,
  col,
  size = 40,
  fps = 5,
}: SuperPelletSpriteProps) {
