...
import { allGhostTypes, Direction, GhostMode, GhostType, Position } from "@/app/core/types";
...
export default function SwordSwingSprite({
    ...
    const getPath = (frame: number) => `/assets/pacman/sword/swordSwing${frame}.png`;
