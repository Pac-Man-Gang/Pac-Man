...
export default function PacmanSprite({ pacman, uiPlayerDir, size = 32, tileSize = 20, fps = 8 }: PacmanSpriteProps) {
    ...
    const arrowX = arrowDir === Direction.E ? arrowOffset :
        arrowDir === Direction.W ? -arrowOffset : 0;
    const arrowY = arrowDir === Direction.S ? arrowOffset :
        arrowDir === Direction.N ? -arrowOffset : 0;
